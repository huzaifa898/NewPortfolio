...
import { Code,  Layout, GitBranch,  Layers, Workflow ,Bug  } from "lucide-react"
...
const skills = [
  ...
  icon: Bug,
  name: "QA Engineering",
  tech: "Manual Testing, Postman, Jira",
  description:
    "Ensuring software quality through detailed test planning, manual test case execution, bug reporting, and API validation.",
  color: "text-red-500",
},
