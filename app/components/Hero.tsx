...
import profpic1 from '@/public/images/profpic1.png'
const CodePattern = () => (
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            <div className="relative w-72 h-72 md:w-96 md:h-96 mx-auto">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-800 to-purple-500 dark:from-blue-600 dark:to-purple-600 rounded-3xl transform rotate-6 opacity-50"></div>
              <div className="absolute inset-0 bg-gradient-to-r from-purple-800 to-blue-500 dark:from-purple-600 dark:to-blue-600 rounded-3xl transform -rotate-6 opacity-50"></div>
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src={profpic1}  // Corrected here
                  alt="Huzaifa Tariq"
                  //fill
                  width={400}
                  height={400}
